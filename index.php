    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('model/image/background/bg-01.jpg');">
            <div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
                <form action="OOP/function/login.php" method="post" class="login100-form validate-form flex-sb flex-w">
                    ...
                    <a href="#" class="btn-google m-b-20">
                        <img src="model/image/icon/icon-google.png" alt="GOOGLE"> Google
                    </a>
